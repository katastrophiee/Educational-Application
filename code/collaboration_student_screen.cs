...
{
    public partial class collaboration_student_screen : navigation_bar
    {
        public collaboration_student_screen()
        {
            InitializeComponent();
        }
        ...
        private void collaboration_student_screen_Shown(object sender, EventArgs e)
        {
