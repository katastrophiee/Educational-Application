...
{
    public partial class collaboration_teacher_screen : navigation_bar
    {
        public collaboration_teacher_screen()
        {
            InitializeComponent();
        }
        ...
        private void collaboration_teacher_screen_Shown(object sender, EventArgs e)
        {
