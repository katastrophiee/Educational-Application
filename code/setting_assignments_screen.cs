...
{
    public partial class setting_assignments_screen : navigation_bar
    {
        public setting_assignments_screen()
        {
            InitializeComponent();
        }
        ...
        private void setting_assignments_screen_Shown(object sender, EventArgs e)
        {
